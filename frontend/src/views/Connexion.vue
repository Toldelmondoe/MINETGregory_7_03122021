            ...
            <div class="row justify-content-center">
                <div class="col-12 col-md-10 col-lg-8">
                    <div class="card bg-light">
                        <p class="h5 my-3 text-center" style="color:#008EAB;">Bienvenu sur le réseau social interne Groupomania</p>
...
export default {
    ...
    methods: {
        handleSubmit() {            
            this.submitted = true
            axios.post('http://localhost:3000/api/auth/signin', { email: this.InputEmail, password: this.InputPassword })
