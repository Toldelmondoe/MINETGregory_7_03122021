...
exports.deleteOneUser = (req, res, next) => {
    ...
    console.log("Id utilisateur : " + req.query.uid)
    console.log("Id utilisateur qui demande la suppression est admin : " + req.query.isAdmin)
    console.log("S'il est admin => suppression de l'utilisateur")
    console.log("S'il n'est pas admin => suppression impossible")
    ...
    if(req.query.isAdmin) {
        ...
        .then((res) => {
            res.status(200).json({ message: "Les messages et les commentaires de l'utilisateur ont été effacés !" })
        })
...
exports.deleteMyAccount = (req, res, next) => {
    console.log("Processus de suppression de compte utilisateur")
